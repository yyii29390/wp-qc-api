            ...
            <tbody id="sim-records-table-body">
                <?php foreach ($sim_records as $sim_record) : ?>
                    <tr>
                        ...
                        <td>
                            <button class="delete-sim-record-button button" data-id="<?php echo esc_attr($sim_record['id']); ?>">Delete</button>
                            <button class="edit-sim-record-button button" data-id="<?php echo esc_attr($sim_record['id']); ?>">Edit</button>
                        </td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
